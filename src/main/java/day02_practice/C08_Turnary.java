 ...
 */
        ...
        System.out.println("lutfen 100 uzerinden notunuzu girinz:");
        int not = scan.nextInt();

        String harfNotu = not > 100 ? "100 den buyuk not giremezsiniz" :
                not > 89 ? "A" :
                        not > 79 ? "B" :
                                not > 69 ? "C" :
                                        not > 59 ? "D" :
                                                not > 49 ? "E" :
                                                        not > -1 ? "F" : " negatif not giremezsiniz";
