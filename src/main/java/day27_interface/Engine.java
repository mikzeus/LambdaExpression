...
public interface Engine {
    ...
    /*
        ...
        4)Bir "interface" i bir "class" in parent'i yapmak istediginizde "extends" keyword
          yerine "implements" keyword kullaniniz.teyze, dayı amca gibi düşünelim
        ...
        12)"interface" lerden "object" olusturulamaz. "interface" lerin "constructor"i yoktur. methotların body si
        olmadığı için yarım sayılır.
